...
{
    [Tooltip("When true, the mouse and mousehweel are used for ship input and A/D can be used for strafing. \n Otherwise WASD/Arrows/Joystick + R/T used for flying")]
    public bool useMouseInput = true;
    [Tooltip("When using Keyboar/Joystick input, should roll be added to horizontal stick movement.")]
    ...
    /// <summary>
    /// Freelancer style mouse controls. Uses mouse to simulate a virtual joystick. When the mouse is in the center of the screen, this is the same as a centered stick.
    /// </summary>
    ...
    /// <summary>
    /// Uses the mouse wheel to control throttle
    /// </summary>
